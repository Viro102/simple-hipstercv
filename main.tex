...
\section*{Start}
\simpleheader{headercolour}{Adam}{Virostek}{University student (3rd year)}{white}
...
\begin{paracol}{2}
    ...
    \infobubble{\faMapMarker}{cvgreen}{white}{Žilina, Slovakia}{https://maps.app.goo.gl/zHjRGioBdP656XJy8}
    ...
    I've used OOP, containerization, HTTP, networking.
